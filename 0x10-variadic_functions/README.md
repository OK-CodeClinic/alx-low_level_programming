...
2. Why do we use Variadic function.
3. How Variadic functions are defined.
4. How to use va_start, va_arg and va_end macros.
5. Why and how to use the const type qualifier.
